    ...
    <div>
        ...
        <ul className='list-group w-100'>
            <div className='row border-bottom p-2 text-dark'>
                ...
                <h5 className='visible-xs'>Szállások listája</h5>
                </div>
                <h5 className='col-xs-4 col-sm-2'>Helyszín</h5>
                <h5 className='col-xs-8 col-sm-3'>Minimum éjszakák száma</h5>
                <h5 className='col-xs-10 col-sm-4'>Ár</h5>
            </div>
                    ...
                    <NavLink key={szallas.id} to={"/szallas/" + szallas.id}>
                        ...
                        <div className='col-xs-12 col-sm-4'>
                            ...
                            <div className='col-xs-4 col-sm-2'>
                                {szallas.neighbourhood_group}
                                {szallas.neighbourhood}</div>
                                <div className='col-xs-8 col-sm-3'>{szallas.minimum_nights}</div>
                                <div className='col-xs-10 col-sm-4'>{szallas.price} €</div> 
                                </div>
                    </NavLink>
               ))}
        </ul>
